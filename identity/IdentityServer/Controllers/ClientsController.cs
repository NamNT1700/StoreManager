...
namespace Server.Identity.Controllers
{
    ...
    public class ClientsController : ControllerBase
    {
        ...
        public async Task<ActionResult<ClientsApiDto>> Get(string searchText, int page = 1, int pageSize = 10)
        {
            ...
            ClientsApiDto clientsApiDto = null;// clientsDto.ToClientApiModel<ClientsApiDto>();
        ...
        public async Task<ActionResult<ClientApiDto>> Get(int id)
        {
            ...
            ClientApiDto clientApiDto = null;// clientDto.ToClientApiModel<ClientApiDto>();
        ...
        public async Task<IActionResult> PostClientClone([FromBody] ClientCloneApiDto client)
        {
            ...
            return CreatedAtAction(nameof(Get), new { id = "" }, new ClientApiDto());
        }
        ...
        public async Task<ActionResult<ClientSecretsApiDto>> GetSecrets(int id, int page = 1, int pageSize = 10)
        {
            ...
            ClientSecretsApiDto clientSecretsApiDto = null;// clientSecretsDto.ToClientApiModel<ClientSecretsApiDto>();
        ...
        public async Task<ActionResult<ClientSecretApiDto>> GetSecret(int secretId)
        {
            ...
            ClientSecretApiDto clientSecretDto = null;// clientSecretsDto.ToClientApiModel<ClientSecretApiDto>();
