...
namespace Server.Identity.Controllers
{
    ...
    public class ApiResourcesController : ControllerBase
    {
        ...
        {
            ApiResourcesApiDto apiResourcesDto = null; //await _apiResourceService.GetApiResourcesAsync(searchText, page, pageSize);
            //var apiResourcesApiDto = apiResourcesDto.ToApiResourceApiModel<ApiResourcesApiDto>();

            return Ok(apiResourcesDto);
        }
        ...
        public async Task<ActionResult<ApiResourceApiDto>> Get(int id)
        {
            ...
            ApiResourceApiDto apiResourceApiDto = null;//apiResourceDto.ToApiResourceApiModel<ApiResourceApiDto>();
        ...
        public async Task<IActionResult> Post([FromBody] ApiResourceApiDto apiResourceApi)
        {
            ...
            return CreatedAtAction(nameof(Get), new { id = "" }, apiResourceApi);
        }
        ...
        public async Task<ActionResult<ApiSecretsApiDto>> GetSecrets(int id, int page = 1, int pageSize = 10)
        {
            ...
            ApiSecretsApiDto apiSecretsApiDto = null;// apiSecretsDto.ToApiResourceApiModel<ApiSecretsApiDto>();
        ...
        public async Task<ActionResult<ApiSecretApiDto>> GetSecret(int secretId)
        {
           // var apiSecretsDto = await _apiResourceService.GetApiSecretAsync(secretId);
            ApiSecretApiDto apiSecretApiDto = null;// apiSecretsDto.ToApiResourceApiModel<ApiSecretApiDto>();
        ...
        public async Task<ActionResult<ApiResourcePropertiesApiDto>> GetProperties(int id, int page = 1, int pageSize = 10)
        {
            ...
            ApiResourcePropertiesApiDto apiResourcePropertiesApiDto = null;// apiResourcePropertiesDto.ToApiResourceApiModel<ApiResourcePropertiesApiDto>();
        ...
        public async Task<ActionResult<ApiResourcePropertyApiDto>> GetProperty(int propertyId)
        {
            ...
            ApiResourcePropertyApiDto apiResourcePropertyApiDto = null;//apiResourcePropertiesDto.ToApiResourceApiModel<ApiResourcePropertyApiDto>();
        ...
        public async Task<IActionResult> PostProperty(int id, [FromBody] ApiResourcePropertyApiDto apiPropertyApi)
        {
            ...
            return CreatedAtAction(nameof(GetProperty), new { propertyId ="null" }, apiPropertyApi);
        }
